...
namespace 毕业生管理系统
{
    public partial class 学生批量导入 : Form
    {
        public 学生批量导入()
        {
            InitializeComponent();
        ...
        private void 学生批量导入_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                sb.Append("('" + dataGridView1.Rows[i].Cells[2].Value.ToString() + "')," + "('" + dataGridView1.Rows[i].Cells[3].Value.ToString() + "')," + "('" + dataGridView1.Rows[i].Cells[4].Value.ToString() + "')," + "('" + dataGridView1.Rows[i].Cells[5].Value.ToString() + "')," + "('" + dataGridView1.Rows[i].Cells[6].Value.ToString() + "')," + "('" + dataGridView1.Rows[i].Cells[7].Value.ToString() + "')");
                sb.Append(")");
